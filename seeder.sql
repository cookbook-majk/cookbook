...
VALUES (now(), 'https://www.femalefirst.co.uk/image-library/square/500/c/cowboy-breakfast.jpg', 'jpg', 0, 'Vaquero Eggs and Bacon', 1),
       ...
       (now(), '/images/default-recipe.jpg', 'jpg', 0, 'Roasted Chicken with Lemon and Rosemary', 4),
       (now(), '/images/default-recipe.jpg', 'jpg', 0, 'Classic Lasagna', 5),
       (now(), '/images/default-recipe.jpg', 'jpg', 0, 'Shrimp Scampi', 6),
       (now(), '/images/default-recipe.jpg', 'jpg', 0, 'Beef Stroganoff', 7),
       (now(), '/images/default-recipe.jpg', 'jpg', 0, 'Caprese Salad', 8),
       (now(), '/images/default-recipe.jpg', 'jpg', 0, 'Spaghetti and Meatballs', 9),
       (now(), '/images/default-recipe.jpg', 'jpg', 0, 'Garlic Shrimp Pasta', 10),
       (now(), '/images/default-recipe.jpg', 'jpg', 0, 'Beef and Vegetable Stew', 11),
       (now(), '/images/default-recipe.jpg', 'jpg', 0, 'Caprese Skewers', 12),
       (now(), '/images/default-recipe.jpg', 'jpg', 0, 'Crispy Baked Chicken', 13),
       (now(), '/images/default-recipe.jpg', 'jpg', 0, 'Greek Salad', 14),
       (now(), '/images/default-recipe.jpg', 'jpg', 0, 'Beef Enchiladas', 15),
       (now(), '/images/default-recipe.jpg', 'jpg', 0, 'Lemon Garlic Shrimp', 16),
       (now(), '/images/default-recipe.jpg', 'jpg', 0, 'Beef and Broccoli Stir Fry', 17),
       (now(), '/images/default-recipe.jpg', 'jpg', 0, 'Caprese Toast', 18),
       (now(), '/images/default-recipe.jpg', 'jpg', 0, 'Baked Salmon with Lemon and Dill', 19),
       (now(), '/images/default-recipe.jpg', 'jpg', 0, 'Tomato and Mozzarella Panini', 20),
       (now(), '/images/default-recipe.jpg', 'jpg', 0, 'Beef Pot Roast', 21),
       (now(), '/images/default-recipe.jpg', 'jpg', 0, 'Caprese Pasta Salad', 22),
       (now(), '/images/default-recipe.jpg', 'jpg', 0, 'Lemon Herb Roasted Chicken', 23),
       (now(), '/images/default-recipe.jpg', 'jpg', 0, 'Avocado Toast with Egg', 24),
       (now(), '/images/default-recipe.jpg', 'jpg', 0, 'Homemade Meatball Subs', 25),
       (now(), '/images/default-recipe.jpg', 'jpg', 0, 'Pesto Chicken with Roasted Vegetables', 26),
       (now(), '/images/default-recipe.jpg', 'jpg', 0, 'Quick and Easy Tuna Salad', 27);
